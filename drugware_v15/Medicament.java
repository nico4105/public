...
public class Medicament {
	...
	public Medicament(String nomMolecule,String nomMarque,double[] doses){
		this.nomMolecule = nomMolecule;
		this.nomMarque = nomMarque;
		this.dosesPossibles = doses;
	}
	...
	public boolean isDosePossible(Medicament med , double dose){
		boolean possible = false;
		
		double[] doses = med.getDosesPossibles();
		for (double d : doses) {
			if(dose == d){
				possible = true;
			}
