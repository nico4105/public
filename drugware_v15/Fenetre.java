...
public class Fenetre extends JFrame {
	...
	public Fenetre() {
		...
		label = new JLabel("Bienvenue dans la gestion de pharmacie");
		panel = new JPanel();
	...
	public void initMenus() {
		...
		menuPresc.setEnabled(false);
		menuMedic.setEnabled(false);
		...
		itemClients2.addActionListener(new BoutonClient2Listener());// BOGUE
	...
	public class BoutonFic1Listener implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			...
			menuMedic.setEnabled(true);
			menuPresc.setEnabled(true);
			itemFic2.setEnabled(true);
			JOptionPane.showMessageDialog(null, "Les fichiers ont été chargés","Message de validation",JOptionPane.INFORMATION_MESSAGE);
		}
	}
	...
	public class BoutonFic2Listener implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			...
			JOptionPane.showMessageDialog(null, "Les fichiers on été mit à jour","Message de validation",JOptionPane.INFORMATION_MESSAGE);
	...
	public class BoutonPresc3Listener implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			String medicament,doses,renouv;
			...
			if (NAM != null && NAM.length() > 0)
				if (pharma.siClientExiste(NAM)){
					medicament = JOptionPane.showInputDialog(null,
							"Entre le nom du médicament",
							"Prescription", JOptionPane.QUESTION_MESSAGE);
					...
					valide = pharma.ajouterPrescription(NAM, medicament,doses,renouv);
					if(!valide) {
						JOptionPane
								.showMessageDialog(
										null,
										"Erreur lors de l'enregistrement vérifiez le numéro d'assurance maladie ou le nomde médicament : ",
										"Prescription", JOptionPane.INFORMATION_MESSAGE);
					}
